...
public class Song extends AudioContent // implement the Comparable interface
{
	...
	public String getType() {
		return TYPENAME; // return the type of the song
	}
	...
	public void play() {
		super.setAudioFile(lyrics); // set the audio file to the lyrics
		super.play(); // play the song
	}
	...
	public boolean equals(Object other) {
		Song song1 = (Song) other;
		if (super.equals(song1) && this.composer.equals(song1.composer) && this.artist.equals(song1.artist)) {
			return true;
		}
		return false;
	}
